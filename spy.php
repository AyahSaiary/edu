							...
							<ul style="padding: 9px 15px;">
								...
								<li class="has-dropdown active">
									...
									<ul class="dropdown" style="width: 200px;">
										...
										<li><a href="components.php">Computer Components</a></li>
			   			...
			   			<div class="row">
				   			<div class="col-md-6 col-sm-12 col-md-offset-3 slider-text">
				   				<div class="slider-text-inner text-center">
				   					<h1> Detecting Spyware </h1>
				   					<h2><span><a href="index.php">Home</a> | <a href="course.html">Courses</a> | Detecting Spyware </span></h2>
				   				</div>
				   			</div>
				   		</div>
			   		</div>
							...
							<div class="col-md-12 animate-box">
								<div class="classes class-single">
										...
										<video style ="width:750px; height:500px;" controls>
										  <source src="videos/spy.mp4" type="video/mp4">

										</video>


									<div class="desc desc2">
										<h3 style="color:#429FFD"> Detecting Spyware  </h3>
										<p> 
										To detect spyware<br>
                                          1- click start<br>
                                          2- Type in the Run box itis regedit Then press the button ok<br>
                                            Open the folders in order in a list registery Editor<br>
                                             -HKEY-LOCAL-MACHINE<br>
                                             -SOFTWARE<br>
                                             -MICROSOFT<br>
                                             -WINDOWS<br>
                                             -CURRENT VERSION <br>
                                            ...
                                            4- On the right side of the screen you will see in the list of NAMES the names of the files that work with the start menu and corresponding in the list of data file title<br>
                                            5- Note well that the file is not matched by the address in the data or has appeared Imam <---- is a spy file deleted and thus you have finished deleting the connection between you and the hacker

                                        </p>

										
								    <br>
										<p><a href="#" class="btn btn-primary btn-outline btn-lg">Another Video</a> or <a href="#" class="btn btn-primary btn-lg">Simple Test</a></p>
									</div>
								</div>
							</div>
						</div>
