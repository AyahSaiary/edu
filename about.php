					...
					<div class="row">
						...
						<div class="col-md-10 text-right menu-1">
							<ul style="padding: 9px 15px;">
								<li><a href="index.php" style="font-size: 18px;padding: 12px 12px; ">Home</a></li>
								<li ><a href="courses.php" style="font-size: 18px;padding: 12px 12px; ">Courses</a></li>
								
								<li  class="active"><a href="about.php" style="font-size: 18px; padding: 12px 12px;">About</a></li>
								<li><a href="contact.php" style="font-size: 18px; padding: 12px 12px;">Contact</a></li>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center colorlib-heading animate-box">
						...
						<p>Our team has designed the site and prepared the videos in an easy and simple way.</p>
					</div>
				</div>
				<div class="row">
					<div class="col-md-4 col-sm-3 animate-box">
						<div class="trainers-entry">
							...
							<div class="desc">
								<h3>Aya Reda</h3>
								<p class="social"><a href="#"  style="color:#fff;">Facebook</a> <a href="#"  style="color:#fff;">Email</a></p>
							</div>
