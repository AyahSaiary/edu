			   			...
			   			<div class="row">
				   			<div class="col-md-6 col-sm-12 col-md-offset-3 slider-text">
				   				<div class="slider-text-inner text-center">
				   					<h1>slow windows problem</h1>
				   					<h2><span><a href="index.php">Home</a> | <a href="course.html">Courses</a> | slow windows problem</span></h2>
				   				</div>
				   			</div>
				   		</div>
			   		</div>
							...
							<div class="col-md-12 animate-box">
								<div class="classes class-single">
										...
										<video style ="width:750px; height:500px;" controls>
										  <source src="videos/restart.mp4" type="video/mp4">

										</video>


									<div class="desc desc2">
										<h3 style="color:#429FFD">Solve slow windows problem</h3>
										<p>Follow these steps to resolve the issue
                                       We write some commands in the command box to delete the empty files for editing the memory
                                      and open the files soon 
                                   and get rid of the files that are found on the version of the version that is causing the weight.</p>
