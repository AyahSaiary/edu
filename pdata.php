			   			...
			   			<div class="row">
				   			<div class="col-md-6 col-sm-12 col-md-offset-3 slider-text">
				   				<div class="slider-text-inner text-center">
				   					<h1>The problem of not appearing data  </h1>
				   					<h2><span><a href="index.php">Home</a> | <a href="course.html">Courses</a> </span>|The problem of not appearing data </h2>
				   				</div>
				   			</div>
				   		</div>
			   		</div>
							...
							<div class="col-md-12 animate-box">
								<div class="classes class-single">
										...
										<video style ="width:750px; height:500px;" controls>
										  <source src="videos/sloww.mp4" type="video/mp4">

										</video>


									<div class="desc desc2">
										<h3 style="color:#429FFD"> The problem of not appearing data   </h3>
										<p> 
										The fault of installing the RAM correctly does not show data on the screen, and also the dust causes the problem.
										All you have to do is remove, clean, and reinstall the RAM.
								    ...
								    <br>
										<p><a href="https://youtu.be/lzOO2GvVQgU" class="btn btn-primary btn-outline btn-lg">Another Video</a> or <a href="qdata.html" class="btn btn-primary btn-lg">Simple Test</a></p>
									</div>
								</div>
							</div>
						</div>
