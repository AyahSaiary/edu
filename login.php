					...
					<div class="row">
						...
						<div class="col-md-10 text-right menu-1">
							<ul style="padding: 9px 15px;">
								...
								<li><div style="width:100px;float:right;margin-left:5px;font-weight:bold;font-family:'Comic Sans MS';font-size: 18px;" action="login.php"><?php echo $username;?></div></li>
