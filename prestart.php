			   			...
			   			<div class="row">
				   			<div class="col-md-6 col-sm-12 col-md-offset-3 slider-text">
				   				<div class="slider-text-inner text-center">
				   					<h1>Problem Restarting Device </h1>
				   					<h2><span><a href="index.php">Home</a> | <a href="course.html">Courses</a> | Problem Restarting Device </span></h2>
				   				</div>
				   			</div>
				   		</div>
			   		</div>
							...
							<div class="col-md-12 animate-box">
								<div class="classes class-single">
										...
										<video style ="width:750px; height:500px;" controls>
										  <source src="videos/pwindows.mp4" type="video/mp4">

										</video>


									<div class="desc desc2">
										<h3 style="color:#429FFD">Problem Restarting Device </h3>
										<p>
										Problem restarting device
                                        Reason: High temperature sensor
                                        Solution: All we have to do is disassemble the fan and place a thermal cream
